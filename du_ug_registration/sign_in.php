...
$sql_c = "SELECT STUDENT_NAME FROM ad_student_msts WHERE SOL_ROLL_NO='".$u_roll_no."'";

	
$cuid_c = oci_parse(ORACLE_CONN, $sql_c);
oci_execute($cuid_c);
$row_cu = oci_fetch_array($cuid_c, OCI_ASSOC + OCI_RETURN_NULLS);	
...
if($sts == 0){
	...
	$msg_show = "Please verify your name: ".$student_name.".<br><br>Please fill the next form for your username and password.<br><br>
	<p style=\"font-size:12px;color:red;line-height:16px;\">* If your name is not matching, Please contact your college.</p>";
...
<div class="modal-footer">
	<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="page_cancel()">CANCEL</button>
	<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="page_reload()">NEXT</button>
</div>
</div>
</div>
</div>	
