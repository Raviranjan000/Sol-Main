...
$row = oci_fetch_array($ctid, OCI_ASSOC + OCI_RETURN_NULLS);
	...
	echo $mobile = "9871795908";//$row['STUDENT_MOBILENUMBER'];
...
echo $url = "https://sol.du.ac.in/du_ug_registration/sms_XML.php?mob=".$mobile."&email=".$email."&stud_name=".$stud_name."&student_password=".$student_password."&flag=forgot";  
